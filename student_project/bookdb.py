...
class BOOKDB(IBOOKDB):
    ...
    def createTables(self):
        ...
        # "books" tablosunu oluştur ve "publisher_id" dış anahtarını tanımla (CASCADE)
        ...
        # "author_of" tablosunu oluştur ve "isbn" ve "author_id" dış anahtarlarını tanımla (CASCADE)
        ...
        # Determine the number of tables created
        cursor = self.connection.cursor()
    ...
    def dropTables(self):
        try:
            cursor = self.connection.cursor()
            # Tabloları silmek için SQL sorgularını oluştur
            drop_table_queries = [
    ...
    def insertPublisher(self,publishers):
        try:
            cursor = self.connection.cursor()
            # Yayınevlerini eklemek için SQL sorgusu hazırla
            sql = "INSERT INTO publisher (publisher_id, publisher_name) VALUES (%s, %s)"
            # Her bir yayınevi için sorguyu çalıştır
    ...
    def functionQ1(self):
        try:
            ...
            print("Sorgu çalıştırılırken bir hata oluştu:", e)
            return []
    ...
    def functionQ8(self):
        ...
        try:
            cursor = self.connection.cursor()
             ...
             # aynı book_name e sahip fakat farklı isbn ye sahip olan kitapalrı bul ve bu kitaplar arasından en küçük ratinge sahip kitap yada kitapların isbn book_name ve ratinglerini bularak tek bir BULK insert  sorgusu ile önceden oluşturduğum phw1 tablosuna insert etmemiz gerekiyor.
            insert_sql = """
            ...
            # Şimdi eklenen verileri isbn'ye göre artan sırada alalım
